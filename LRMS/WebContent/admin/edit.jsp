...
<html>
  <head>
	...
	<script type="text/javascript">
		function update(){
			$.post("adminservice!update.action",{'admin.name':$("#name").val(),'admin.pwd':$("#pwd").val(),'id':$("#id").val(),'admin.phone':$('#phone').val()},function(result){
...
<div class="well">
    ...
    <form id="tab">
    	<input type="hidden" id="id" value="<s:property value="#request.admin.id" />">
        <label>管理员编号</label>
        <input type="text" class="input-xlarge" name="admin.no" id="no" value="<s:property value="#request.admin.no" />" >
        <label>管理员姓名</label>
        <input type="text" class="input-xlarge" name="admin.name" id="name" value="<s:property value="#request.admin.name" />" >
        <label>电话</label>
        <input type="text" class="input-xlarge" name="admin.phone" id="phone" value="<s:property value="#request.admin.phone" />" >
        <label>密码</label>
        <input type="password" class="input-xlarge" name="admin.pwd" id="pwd" value="">
    </form>
      </div>
  </div>
