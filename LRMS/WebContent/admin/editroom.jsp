...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function add(){
			$.post("roomservice!update.action",{'room.name':$("#name").val(),'room.location':$("#location").val(),'room.remark':$("#remark").val(),id:$("#id").val(),'room.stuNum':$('#stuNum').val()},function(result){
...
<div class="well">
    ...
    <form id="tab">
    	<input type="hidden" id="id" value="<s:property value="#request.room.id" />">
        <label>实验室名称</label>
        <input type="text" class="input-xlarge" name="room.name" id="name" value="<s:property value="#request.room.name" />">
        <label>实验室位置</label>
        <input type="text" class="input-xlarge" name="room.location" id="location" value="<s:property value="#request.room.location" />">
        <label>容纳人数</label>
        <input type="text" class="input-xlarge" name="room.stuNum" id="stuNum" value="<s:property value="#request.room.stuNum" />">
        <label>备注</label>
        <input type="text" class="input-xlarge" name="room.remark" id="remark" value="<s:property value="#request.room.remark" />">
    </form>
      </div>
  </div>
