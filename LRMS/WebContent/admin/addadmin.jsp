...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function add(){
			$.post("adminservice!add.action",{'admin.no':$("#no").val(),'admin.name':$("#name").val(),'admin.pwd':$("#pwd").val(),'admin.phone':$("#phone").val()},function(result){
        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="account-menu" class="nav nav-list collapse in">
                  ...
                  <s:if test="#session.user.type==2">
                  	<li ><a href="studentservice!edit.action">设置用户</a></li>
                  </s:if>
...
<div class="well">
    ...
    <form id="tab">
        <label>管理员编号</label>
        <input type="text" class="input-xlarge" name="no" id="no">
        <label>管理员姓名</label>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <p class="error-text"><i class="icon-warning-sign modal-icon"></i>点击确定将不保存管理员信息?</p>
  </div>
