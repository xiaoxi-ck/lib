...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function add(){
			$.post("teacherservice!add.action",{'teacher.courseName':$("#courseName").val(),'teacher.no':$("#no").val(),'teacher.name':$("#name").val(),'teacher.phone':$("#phone").val()},function(result){
...
<div class="well">
    ...
    <form id="tab">
        ...
        <label>指导课程</label>
        <input type="text" class="input-xlarge" name="teacher.courseName" id="courseName">
    </form>
      </div>
  </div>
